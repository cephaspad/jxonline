...
public class WebAppModule : AbpModule
{
        ...
        Configure<AbpBundlingOptions>(options =>
        {
            ...
            options.StyleBundles.Configure(
                ...
                bundle =>
                {
                    ...
                    bundle.AddFiles("/JXOnline.WebApp.styles.css");
                }
            );
        });
    }
    ...
    private void ConfigureRouter(ServiceConfigurationContext context)
    {
        ...
        {
            options.AppAssembly = typeof(WebAppModule).Assembly;
        });
    }
    ...
    private void ConfigureAutoApiControllers()
    {
        ...
        {
            options.ConventionalControllers.Create(typeof(WebAppModule).Assembly);
        });
    }
    ...
    {
        context.Services.AddAutoMapperObjectMapper<WebAppModule>();
        Configure<AbpAutoMapperOptions>(options =>
        {
             ...
             */
            options.AddMaps<WebAppModule>(/* validate: true */);
        });
    }
    ...
    private void ConfigureVirtualFiles(IWebHostEnvironment hostingEnvironment)
    {
        ...
        {
            options.FileSets.AddEmbedded<WebAppModule>();
            if (hostingEnvironment.IsDevelopment())
            {
                /* Using physical files in development, so we don't need to recompile on changes */
                options.FileSets.ReplaceEmbeddedByPhysical<WebAppModule>(hostingEnvironment.ContentRootPath);
            }
        });
    }
    ...
    {
        context.Services.AddAbpDbContext<WebAppDbContext>(options =>
        {
