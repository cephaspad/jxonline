...
public class WebAppTenantDatabaseMigrationHandler :
    ...
    ITransientDependency
{
    ...
    private readonly ILogger<WebAppTenantDatabaseMigrationHandler> _logger;

    public WebAppTenantDatabaseMigrationHandler(
        WebAppDbSchemaMigrator dbSchemaMigrator,
        ICurrentTenant currentTenant,
        IUnitOfWorkManager unitOfWorkManager,
        IDataSeeder dataSeeder,
        ITenantStore tenantStore,
        ILogger<WebAppTenantDatabaseMigrationHandler> logger)
    {
